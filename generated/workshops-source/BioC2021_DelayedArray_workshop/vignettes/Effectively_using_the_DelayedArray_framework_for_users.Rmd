...
author: "Peter Hickey"
date: "Last modified: May 25, 2021; Compiled: `r format(Sys.time(), '%B %d, %Y')`"
...
output:
  rmarkdown::html_document:
   ...
   fig_width: 5
vignette: >
  %\VignetteIndexEntry{BioC 2021 DelayedArray workshop}
...
However, the brain also has extensive non-CpG methylation and there are an order of magnitude more non-CpG loci than CpG loci.
...
`r knitr::include_graphics("images/block_processing_1.png")`
`r knitr::include_graphics("images/block_processing_2.png")`
`r knitr::include_graphics("images/block_processing_3.png")`
`r knitr::include_graphics("images/block_processing_4.png")`
`r knitr::include_graphics("images/block_processing_5.png")`
`r knitr::include_graphics("images/block_processing_6.png")`
`r knitr::include_graphics("images/block_processing_7.png")`
...
A 1-hour workshop can not cover everything in the DelayedArray framework.
Here are some important topics that I omitted and some brief references to further resources are:
